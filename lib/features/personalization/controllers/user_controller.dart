...
import 'package:t_store/features/personalization/screens/profile/widget/re_authenthicate_user_login_form.dart';
...
class UserController extends GetxController {
  ...
  Future<void> fetchUserRecord() async {
    try {
      ...
      final user = await userRepository.fetchUsersDetails();
      this.user(user);
    } catch (e) {
    ...
    try {
      ...
      if (provider.isNotEmpty) {
        if (provider == 'google.com') {
          ...
          await auth.deleteAccount(auth.authUser!.uid, provider);
